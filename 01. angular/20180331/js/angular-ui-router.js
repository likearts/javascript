 ...
 * ui-router.js uses `copy` only to make copies of state parameters.
 */
 ...
 * ### ES6
 * ```js
 * import {trace} from "ui-router.js-ng2"; // or "angular-ui-router.js"
 * trace.enable(1, 5); // TRANSITION and VIEWCONFIG
 * ```
 *
 * ### CJS
 * ```js
 * let trace = require("angular-ui-router.js").trace; // or "ui-router.js-ng2"
 * trace.enable("TRANSITION", "VIEWCONFIG");
 * ```
 *
 * ### Globals
 * ```js
 * let trace = window["angular-ui-router.js"].trace; // or "ui-router.js-ng2"
...
var Trace = (function () {
    ...
    /** @internalapi called by ui-router.js code */
 ...
 * #### Example:
 * ```js
 * import {trace} from "angular-ui-router.js";
 * trace.enable(1, 5);
 * ```
 */
var trace = new Trace();
...
var TransitionHook = (function () {
     ...
     * to a stopped router.js (disposed), or a new transition has started and superseded this one.
     */
    TransitionHook.prototype.getNotCurrentRejection = function () {
        var router = this.transition.router;
        // The router.js is stopped
        if (router._disposed) {
...
var StateBuilder = (function () {
    function StateBuilder(matcher, urlMatcherFactory) {
        ...
        this.builders = {
            ...
            // Each framework-specific ui-router.js implementation should define its own `views` builder
...
var UrlRuleFactory = (function () {
     ...
     * - router.js: the router.js object ([[UIRouter]])
     *
     * #### Example:
     * ```js
     ...
     * #### Example:
     * ```js
     * var rule = factory.fromState($state.get('foo'), router.js);
     * var match = rule.match('/foo/123/456'); // results in { fooId: '123', barId: '456' }
    ...
    UrlRuleFactory.prototype.fromState = function (state, router) {
         ...
         *
         * First checks if the router.js should start a new transition.
...
var UIRouter = (function () {
    ...
    /** Registers an object to be notified when the router.js is disposed */
    UIRouter.prototype.disposable = function (disposable) {
        this._disposables.push(disposable);
    };
    /**
     * Disposes this router.js instance
     *
     * When called, clears resources retained by the router.js by calling `dispose(this)` on all
     ...
     * #### Example:
     * ```js
     * import { MyCoolPlugin } from "ui-router.js-cool-plugin";
     *
     * var plugin = router.js.addPlugin(MyCoolPlugin);
     * ```
     *
     * ### Plugin authoring
     *
     ...
     * For example, it may configure router.js options or add a Transition Hook.
     *
     ...
     *   constructor(router.js: UIRouter, options: any) {
     *     this.name = "MyAuthPlugin";
     *     let $transitions = router.js.transitionService;
     *     let $state = router.js.stateService;
     *
     *     let authCriteria = {
 ...
 *
 * This class provides services related to ui-router.js states.
...
var StateService = (function () {
     ...
     * #### Example:
     * ```js
     * let app angular.module('app', ['ui.router.js']);
     *
     ...
     * `{ location: true, inherit: true, relative: router.js.globals.$current, notify: true }`.
     * This allows you to use either an absolute or relative `to` argument (because of `relative: router.js.globals.$current`).
 ...
 * The `angular-ui-router.js` (ui-router.js for angular 1) uses the $q API provided by angular.
 *
 * $q-like promise api
 */
var $q = {
 ...
 *
 * The classes and interfaces that are core to ui-router.js and do not belong
 ...
 *
 * The `$stateProvider` works similar to Angular's v1 router.js, but it focuses purely
 * on state.
 *
...
var StateProvider = (function () {
     ...
     * This can be used to add custom functionality to ui-router.js,
     ...
     * - **url** `{object}` - returns a {@link ui.router.js.util.type:UrlMatcher UrlMatcher}
     *   or `null`.
 ...
 * For configuring URL rules, use the [[UrlRulesApi]] which can be found as [[UrlService.rules]].
 *
 * This class manages the router.js rules for what to do when the URL changes.
 *
...
var UrlRouterProvider = (function () {
     ...
     * #### Example:
     * ```js
     * var app = angular.module('app', ['ui.router.js.router.js']);
     *
     ...
     *
     * This can be useful to perform some asynchronous initialization before the router.js starts.
     * Once the initialization is complete, call [[listen]] to tell UI-Router to start watching and synchronizing the URL.
     *
     * #### Example:
     * ```js
     * var app = angular.module('app', ['ui.router.js']);
     *
     * app.config(function ($urlRouterProvider) {
...
function $uiRouter($locationProvider) {
    ...
    // backwards compat: also expose router.js instance as $uiRouterProvider.router.js
 ...
 *
 * - [[$uiViewScrollProvider]]: Disable ui-router.js view scrolling
            ...
            compile: function (tElement, tAttrs, $transclude) {
                return function (scope, $element, attrs) {
                    ...
                    function updateView(config) {
                        ...
                        /**
                         * @ngdoc event
                         * @name ui.router.js.state.directive:ui-view#$viewContentLoading
                         * @eventOf ui.router.js.state.directive:ui-view
                        ...
                        /**
                         * @ngdoc event
                         * @name ui.router.js.state.directive:ui-view#$viewContentLoaded
                         * @eventOf ui.router.js.state.directive:ui-view
                         * @eventType emits on ui-view directive scope
                         * @description           *
...
/** @hidden */
var hasComponentImpl = typeof ng.module('ui.router.js')['component'] === 'function';
...
ng.module('ui.router.js.state').directive('uiView', uiView);
ng.module('ui.router.js.state').directive('uiView', $ViewDirectiveFill);
...
ng.module('ui.router.js.state').provider('$uiViewScroll', $ViewScrollProvider);
...
//# sourceMappingURL=angular-ui-router.js.js.map
